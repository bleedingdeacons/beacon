...
/**
 * Build Script for Beacon WordPress Plugin
 *
...
class PluginBuilder
{
    ...
    private string $pluginName = 'beacon';
    private string $mainFile = 'beacon.php';
    private string $versionConstant = 'BEACON_VERSION';
...
Beacon WordPress Plugin Build Script
====================================
Platform: {$platform}
